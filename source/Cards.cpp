...
void cards::showHand(sf::RenderWindow & w, cards::Hand const& h, cards::Sprite const& cs, cards::BackSprite const& bs, std::array<int, 2> origin, int actual, int owner, bool rotate = false) {
	sf::Sprite s;
	std::list<int> c[4];
